...
const ProjectCard = ({ project }) => {
    return < Card className='group overflow-hidden relative'>
        <CardHeader className='p-0 mb-10'>
            <div className='relative w-full h-[300px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow-hiddenhidden'>
